...
import sty from "./PlasmicPageLayout.module.css"; // plasmic-import: fgcJMuJyC81a/css

import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: VtoVsXZZyM4s/icon
import Icon2Icon from "./icons/PlasmicIcon__Icon2"; // plasmic-import: HeGsSEjQguUk/icon
...
function PlasmicPageLayout__RenderFunc(props: {
  ...
  return (
    <RichLayout
      ...
      logoElement={
        <Icon2Icon
          className={classNames(projectcss.all, sty.svg__knDqf)}
          role={"img"}
        />
      }
      navMenuItems={(() => {
    ...
    >
      <LoadingBoundary
        ...
        loadingState={
          <DataCtxReader__>
            {$ctx => (
              <div className={classNames(projectcss.all, sty.freeBox__vunJk)}>
                <IconIcon
                  className={classNames(projectcss.all, sty.svg___3NEys)}
                  role={"img"}
                />
              </div>
            )}
      ...
      >
        <DataCtxReader__>
          {$ctx => (
            <div className={classNames(projectcss.all, sty.freeBox__hYnF9)}>
              {renderPlasmicSlot({
                defaultContents: (
                  <section
                    className={classNames(projectcss.all, sty.section___93GsK)}
                  >
                    <h1
                      className={classNames(
                        projectcss.all,
